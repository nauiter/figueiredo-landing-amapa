...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#b8806e] via-[#8b5e4a] to-[#1a1a1a]">
      {/* Subtle glow effect on edges */}
      <div className="absolute inset-0 bg-gradient-to-r from-[#b8806e]/20 via-transparent to-[#b8806e]/20"></div>
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-5xl mx-auto text-center space-y-8">
          ...
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white leading-tight animate-fade-in" style={{ animationDelay: "0.1s" }}>
            Soluções Jurídicas Confiáveis e Eficientes no Amapá
          </h1>

          <h2 className="text-xl md:text-2xl lg:text-3xl text-white/90 font-light max-w-3xl mx-auto animate-fade-in" style={{ animationDelay: "0.3s" }}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8 animate-fade-in" style={{ animationDelay: "0.7s" }}>
            <Button 
              size="lg" 
